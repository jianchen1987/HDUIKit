//
//  HDStarRatingViewController.m
//  HDUIKit_Example
//
//  Created by VanJay on 2020/3/14.
//  Copyright © 2020 wangwanjie. All rights reserved.
//

#import "HDStarRatingViewController.h"

@interface HDStarRatingViewController ()

@end

@implementation HDStarRatingViewController
...
- (void)setupForTestingStarRatingView {
    ...
    UIScrollView *scrollView = ({
        ...
        view.frame = CGRectMake(0, self.hd_navigationBar.bottom, self.view.width, self.view.height - self.hd_navigationBar.bottom);
    ...
    for (UIView *subView in scrollView.subviews) {
        ...
        subView.frame = (CGRect){30, (lastView ? CGRectGetMaxY(lastView.frame) : 25) + ([lastView isKindOfClass:UILabel.class] ? 10 : (!!lastView ? 30 : 0)), size};
        lastView = subView;
    }
