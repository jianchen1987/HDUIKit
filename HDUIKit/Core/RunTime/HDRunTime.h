...
@interface HDPropertyDescriptor : NSObject
...
OverrideImplementation(Class targetClass, SEL targetSelector, id (^implementationBlock)(__unsafe_unretained Class originClass, SEL originCMD, IMP (^originalIMPProvider)(void))) {
    ...
    if (hasOverride) {
        ...
        const char *typeEncoding = method_getTypeEncoding(originMethod) ?: [targetClass instanceMethodSignatureForSelector:targetSelector].hd_typeEncoding;
 ...
 */
#define _HDTypeEncodingDetectorGenerator(_TypeInFunctionName, _typeForEncode) \
...
_HDTypeEncodingDetectorGenerator(Char, char)
_HDTypeEncodingDetectorGenerator(Int, int)
_HDTypeEncodingDetectorGenerator(Short, short)
_HDTypeEncodingDetectorGenerator(Long, long)
_HDTypeEncodingDetectorGenerator(LongLong, long long)
_HDTypeEncodingDetectorGenerator(NSInteger, NSInteger)
_HDTypeEncodingDetectorGenerator(UnsignedChar, unsigned char)
_HDTypeEncodingDetectorGenerator(UnsignedInt, unsigned int)
_HDTypeEncodingDetectorGenerator(UnsignedShort, unsigned short)
_HDTypeEncodingDetectorGenerator(UnsignedLong, unsigned long)
_HDTypeEncodingDetectorGenerator(UnsignedLongLong, unsigned long long)
_HDTypeEncodingDetectorGenerator(NSUInteger, NSUInteger)
_HDTypeEncodingDetectorGenerator(Float, float)
_HDTypeEncodingDetectorGenerator(Double, double)
_HDTypeEncodingDetectorGenerator(CGFloat, CGFloat)
_HDTypeEncodingDetectorGenerator(BOOL, BOOL)
_HDTypeEncodingDetectorGenerator(Void, void)
_HDTypeEncodingDetectorGenerator(Character, char *)
_HDTypeEncodingDetectorGenerator(Object, id)
_HDTypeEncodingDetectorGenerator(Class, Class)
_HDTypeEncodingDetectorGenerator(Selector, SEL)

#define _HDGetIvarValueGenerator(_TypeInFunctionName, _typeForEncode) \
...
_HDGetIvarValueGenerator(Char, char)
_HDGetIvarValueGenerator(Int, int)
_HDGetIvarValueGenerator(Short, short)
_HDGetIvarValueGenerator(Long, long)
_HDGetIvarValueGenerator(LongLong, long long)
_HDGetIvarValueGenerator(UnsignedChar, unsigned char)
_HDGetIvarValueGenerator(UnsignedInt, unsigned int)
_HDGetIvarValueGenerator(UnsignedShort, unsigned short)
_HDGetIvarValueGenerator(UnsignedLong, unsigned long)
_HDGetIvarValueGenerator(UnsignedLongLong, unsigned long long)
_HDGetIvarValueGenerator(Float, float)
_HDGetIvarValueGenerator(Double, double)
_HDGetIvarValueGenerator(BOOL, BOOL)
_HDGetIvarValueGenerator(Character, char *)
_HDGetIvarValueGenerator(Selector, SEL)
...
/**
 ...
 int count = hd_getProjectClassList(&classes);
