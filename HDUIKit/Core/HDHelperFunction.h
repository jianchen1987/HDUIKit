...
#ifndef HDHelperFunction_h
#define HDHelperFunction_h
...
setterWithGetter(SEL getter) {
    ...
    [setterString appendString:getterString.hd_capitalizedString];
