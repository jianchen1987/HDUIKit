...
@property (nonatomic, strong) UIColor *textFieldTintColor;                ///< 光标颜色
...
@property (nonatomic, assign) BOOL shouldSeparatedReverse;                ///< 倒序分隔，默认为 NO
@property (nonatomic, assign) BOOL separatedReverseUnitLength;            ///< 倒序分隔单位长度，默认为3
