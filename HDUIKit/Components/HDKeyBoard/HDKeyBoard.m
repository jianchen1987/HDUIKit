...
@property (nonatomic, strong) HDUIButton *enterpriseBtn;                                                     ///< 商业信息
...
- (void)setup {
    ...
    _enterpriseBtn = [HDUIButton buttonWithType:UIButtonTypeCustom];
    _enterpriseBtn.adjustsImageWhenDisabled = NO;
    _enterpriseBtn.enabled = NO;
    if (HDIsStringNotEmpty(self.theme.enterpriseLogoImage)) {
        ...
        if (self.theme.enterpriseShowStyle == HDKeyBoardEnterpriseInfoShowTypeImageLeft) {
            _enterpriseBtn.imageEdgeInsets = UIEdgeInsetsMake(0, 0, 0, self.theme.enterpriseMargin);
        } else {
            _enterpriseBtn.imageEdgeInsets = UIEdgeInsetsMake(0, self.theme.enterpriseMargin, 0, 0);
        }
    }
    _enterpriseBtn.contentMode = UIViewContentModeCenter;
