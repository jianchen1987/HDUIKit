...
typedef NS_ENUM(NSUInteger, HDPieProgressViewShape) {
    HDPieProgressViewShapeSector,  ///< 扇形，默认
    HDPieProgressViewShapeRing     ///< 环形
};

NS_ASSUME_NONNULL_BEGIN

@interface HDPieProgressView : UIControl
...
/**
 绘制形状，默认是扇形。
 */
@property (nonatomic, assign) IBInspectable HDPieProgressViewShape shape;
